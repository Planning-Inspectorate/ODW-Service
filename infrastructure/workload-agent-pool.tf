...
moved {
  from = module.devops_agent_pool_failover[0].azurerm_linux_virtual_machine_scale_set.devops_agent_pool[0]
  to   = module.devops_agent_pool_failover.azurerm_linux_virtual_machine_scale_set.devops_agent_pool[0]
}

moved {
  from = module.devops_agent_pool_failover[0].azurerm_resource_group.devops_agents
  to   = module.devops_agent_pool_failover.azurerm_resource_group.devops_agents
}

moved {
  from = module.devops_agent_pool_failover[0].random_password.devops_agent_password[0]
  to   = module.devops_agent_pool_failover.random_password.devops_agent_password[0]
}