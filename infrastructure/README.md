...
| <a name="output_function_app_subscriptions"></a> [function\_app\_subscriptions](#output\_function\_app\_subscriptions) | A map of Subscription Name to Subscription Keys (used for consumer RBAC assignments) |
