...
| <a name="input_api_connection_servicebus_enabled"></a> [api\_connection\_servicebus\_enabled](#input\_api\_connection\_servicebus\_enabled) | Determines whether a Logic App Standard function should be deployed | `bool` | `false` | no |
