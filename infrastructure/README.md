...
| <a name="input_display_name"></a> [display\_name](#input\_display\_name) | The display name of the resources which will be deployed | `string` | `""` | no |
...
| <a name="input_name"></a> [name](#input\_name) | The display name of the resources which will be deployed | `string` | `""` | no |
