...
| <a name="input_logic_app_storage_account_failover"></a> [logic\_app\_storage\_account\_failover](#input\_logic\_app\_storage\_account\_failover) | The name of the storage account used by the Logic App | `string` | n/a | yes |
