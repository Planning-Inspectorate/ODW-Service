...
| <a name="input_logic_app_storage_account"></a> [logic\_app\_storage\_account](#input\_logic\_app\_storage\_account) | The name of the storage account for the Logic App | `string` | n/a | yes |
