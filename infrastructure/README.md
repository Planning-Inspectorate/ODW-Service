...
| <a name="input_apim_api_policies"></a> [apim\_api\_policies](#input\_apim\_api\_policies) | A map of API names to API Management API policy XML files | `list(map(string))` | n/a | yes |
| <a name="input_apim_apis"></a> [apim\_apis](#input\_apim\_apis) | A map of API names to API Management API objects | `list(map(string))` | n/a | yes |
...
| <a name="input_apim_products"></a> [apim\_products](#input\_apim\_products) | A map of product IDs to API Management product objects | `list(map(string))` | n/a | yes |
