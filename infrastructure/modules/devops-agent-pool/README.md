...
| <a name="input_devops_agent_subnet_id"></a> [devops\_agent\_subnet\_id](#input\_devops\_agent\_subnet\_id) | The ID of the subnet into which the devops agent VM Scale Set will be deployed | `string` | n/a | yes |
