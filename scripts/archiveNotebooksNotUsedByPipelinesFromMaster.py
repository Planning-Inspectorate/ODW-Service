...
def extract_notebooks_from_unused_pipelines(pipeline_dir, unused_pipelines):
    """
    Extracts notebooks from unused pipelines.
    """
    all_notebooks = []
...
def archive_notebook(notebook_name, notebook_dir):
    ...
    if "name" in folder and not folder["name"].startswith("archive"):
        ...
        print(f"Archiving notebook: {notebook_name}")
        return True
...
def archive_notebooks(notebooks, notebook_dir):
    """
    Archives all notebooks in the given list.
    """
...
def main(): 
    ...
    print(f"Total unused pipelines: {unused_pipelines}")

    # Extract notebooks from unused pipelines
    notebooks = extract_notebooks_from_unused_pipelines(pipeline_dir, unused_pipelines)

    # Archive the notebooks
    if notebooks:
        print("Archiving notebooks referenced in unused pipelines...")
        archive_notebooks(notebooks, notebook_dir)
    else:
        print("No notebooks found in unused pipelines.")
