...
if __name__ == "__main__":
    ...
    parser.add_argument("-pn", "--pool_name", help="The name of the pool to create")
    args = parser.parse_args()
    synapse_workspace = args.synapse_workspace
    pool_name = args.pool_name
    logging.info(f"Creating spark pool with name '{pool_name}'")
    SynapseSparkPoolUtil(synapse_workspace).create(pool_name)
