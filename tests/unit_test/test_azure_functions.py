...
class TestAzureFunctions(TestCase):
    CLIENT = SecretClient(vault_url="https://pinskvsynwodwdevuks.vault.azure.net", credential=AzureCliCredential())
    ...
    def test_azure_function_calls(self, test_parameters: str):
        ...
        function_url = f"{self.CLIENT.get_secret(function_secret_name)}{url_parameters}"
